...
public class TableTestInteg extends IntegrationTest {
	...
	public void testException() {
		...
		assertTrue(test.view.flexTable.getCellFormatter().getStyleName(0, 1).contains(test.view.css.InputError()));
		...
		assertFalse(test.view.flexTable.getCellFormatter().getStyleName(0, 1).contains(test.view.css.InputError()));
