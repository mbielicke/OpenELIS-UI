...
public class GwtTable extends IntegrationTest {
	...
	public void testException() {
		...
		assertEquals("fdsdf",test.view.table().getText(0, 1));
		assertEquals("fdsdf",test.getValueAt(0, 1));
		assertTrue(test.view.table().getCellFormatter().getStyleName(0, 1).contains(test.view.css().InputError()));
		...
		assertEquals("4",test.view.table().getText(0, 1));
		assertEquals(new Integer(4), test.getValueAt(0, 1));
		assertFalse(test.view.table().getCellFormatter().getStyleName(0, 1).contains(test.view.css().InputError()));
