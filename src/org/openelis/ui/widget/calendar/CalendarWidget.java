    ...
    */
    ...
    public CalendarWidget(byte begin, byte end) throws Exception {
    	...
    	*/
        ...
        //service = new ScreenService("controller?service=org.openelis.ui.server.CalendarService");
    ...
    private void setDateDisplay() {
        ...
        switch(month) {
        	case 0 :
        		monthText = Messages.get().month0();
        		break;
        	case 1 : 
        		monthText = Messages.get().month1();
        		break;
        	case 2 : 
        		monthText = Messages.get().month2();
        		break;
        	case 3 : 
        		monthText = Messages.get().month3();
        		break;
        	case 4 : 
        		monthText = Messages.get().month4();
        		break;
        	case 5 : 
        		monthText = Messages.get().month5();
        		break;
        	case 6 : 
        		monthText = Messages.get().month6();
        		break;
        	case 7 : 
        		monthText = Messages.get().month7();
        		break;
        	case 8 : 
        		monthText = Messages.get().month8();
        		break;
        	case 9 : 
        		monthText = Messages.get().month9();
        		break;
        	case 10 : 
        		monthText = Messages.get().month10();
        		break;
        	case 11 : 
        		monthText = Messages.get().month11();
        		break;
        }
