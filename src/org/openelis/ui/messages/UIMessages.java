 ...
 * 	/home/mbielick/workspace-production/OpenELIS-UI/bin/org/openelis/ui/messages/UIMessages.properties'.
 */
public interface UIMessages extends com.google.gwt.i18n.client.Messages {
  ...
  @Key("exc.entityLock")
  String exc_entityLock(String arg0,  java.util.Date arg1);
  ...
  @Key("exc.modulePerm")
  String exc_modulePerm(String arg0,  String arg1);
  ...
  @Key("exc.screenPerm")
  String exc_screenPerm(String arg0);
  ...
  @Key("exc.sectionPerm")
  String exc_sectionPerm(String arg0,  String arg1);
  ...
  String gen_dateTimeSecondPattern();
  ...
  String msg_enterInformationPressCommit();
  ...
  String report_generatingReport();
