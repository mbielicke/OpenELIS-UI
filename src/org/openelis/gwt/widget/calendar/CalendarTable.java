...
public class CalendarTable extends Composite implements HasSelectionHandlers<Datetime> {
    ...
    public CalendarTable() {
    	css = UIResources.INSTANCE.calendar();
    	css.ensureInjected();
