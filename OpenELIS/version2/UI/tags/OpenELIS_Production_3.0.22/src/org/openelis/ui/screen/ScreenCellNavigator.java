...
import org.openelis.ui.widget.celltable.Table;
 ...
 */
public abstract class ScreenCellNavigator<T extends Serializable> {
    ...
    public ScreenCellNavigator(Table<T> table, Button next, Button prev) {
        oldPage = -1;
        selection = -1;
        this.table = table;
        atozNext = next;
    ...
    public void setQueryResult(ArrayList<T> result) {
        int row;
     ...
     *         null.
     */
    public abstract ArrayList<T> getModel();
