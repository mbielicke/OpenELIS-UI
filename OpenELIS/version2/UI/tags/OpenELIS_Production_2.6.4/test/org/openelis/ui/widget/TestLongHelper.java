...
public class TestLongHelper {
    ...
    public void getValue() throws Exception {
        assertEquals(new Long(54),helper.getValue("54"));
    }
    ...
    @Test 
    public void format() {
        assertEquals("54",helper.format(new Long(54)));
    }
    
    @Test
    public void isCorrectType() {
        assertTrue(helper.isCorrectType(null));
        assertTrue(helper.isCorrectType(new Long(4)));
        assertFalse(helper.isCorrectType("4"));
    }
    
    @Test 
    public void validate() {
        assertTrue(helper.validate(new Long(4)).isEmpty());
