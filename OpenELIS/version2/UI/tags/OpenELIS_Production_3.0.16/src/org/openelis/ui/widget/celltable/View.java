...
public class View extends ViewInt {
    ...
    protected void cellClicked(MouseEvent<?> event) {
    	int r,c;
        ...
        if(table.fireCellClickedEvent(r, c, event.isControlKeyDown(),event.isShiftKeyDown(), event instanceof DoubleClickEvent))
