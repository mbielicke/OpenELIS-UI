...
public class FlexTable extends com.google.gwt.user.client.ui.FlexTable {
	...
	protected HandlerRegistration addCellMouseOverHandler(CellMouseOverEvent.Handler handler) {
	...
	protected void removeHandler(int row, int col) {
	    if(registeredCells.containsKey(row+":"+col))
	        registeredCells.remove(row+":"+col).removeHandler();
	}
	
	protected HandlerRegistration addCellMouseOutHandler(CellMouseOutEvent.Handler handler) {
