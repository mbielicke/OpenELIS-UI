...
public class ExceptionHelper {
    ...
    protected static final org.openelis.ui.widget.Window            window;
     ...
     */
    static {
    	css = UIResources.INSTANCE.dialog();
    ...
    public static void drawExceptions(ArrayList<Exception> endUser, ArrayList<Exception> valid,final int x, final int y) {
        ArrayList<Exception> exceptions = null;
        Grid grid;
