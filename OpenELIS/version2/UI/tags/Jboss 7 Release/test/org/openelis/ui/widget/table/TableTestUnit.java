    ...
    public void testSelection() {
        ...
        new Timer() {
            public void run() {
                ...
                assertTrue(test.view.flexTable.getRowFormatter()
                                              .getStyleName(0)
                ...
                assertTrue(test.view.flexTable.getRowFormatter()
                                              .getStyleName(1)
                                              .contains(test.view.css.Selection()));
                assertFalse(test.view.flexTable.getRowFormatter()
                                               .getStyleName(0)
                                               .contains(test.view.css.Selection()));
    ...
    public void testSetValueAt() {
        ...
        new Timer() {
            public void run() {
                ...
                assertTrue(test.view.flexTable.getCellFormatter()
                                              .getStyleName(0, 0)
                ...
                assertFalse(test.view.flexTable.getCellFormatter()
                                               .getStyleName(0, 0)
                                               .contains(test.view.css.InputError()));
        ...
        new Timer() {
            public void run() {
                ...
                assertEquals(test.getColumnWidget(0),
                             ((AbsolutePanel)test.view.flexTable.getWidget(0, 0)).getWidget(0));
    ...
    public void testScrollToVisible() {
        ...
        new Timer() {
            public void run() {
                ...
                assertEquals(15, test.view.lastVisibleRow);
