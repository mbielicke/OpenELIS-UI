	    ...
	    for(int i = 0; i < 10; i++)
	    	switch(i) {
	    		case 0 :
	    			...
	    			year0.setAction(String.valueOf((yr+i)-1900));
	    			break;
	    		case 1 :
	    			year1.setText(String.valueOf(yr+i));
	    			year1.setAction(String.valueOf((yr+i)-1900));
	    			break;
	    		case 2 :
	    			year2.setText(String.valueOf(yr+i));
	    			year2.setAction(String.valueOf((yr+i)-1900));
	    			break;
	    		case 3 :
	    			year3.setText(String.valueOf(yr+i));
	    			year3.setAction(String.valueOf((yr+i)-1900));
	    			break;
	    		case 4 :
	    			year4.setText(String.valueOf(yr+i));
	    			year4.setAction(String.valueOf((yr+i)-1900));
	    			break;
	    		case 5 :
	    			year5.setText(String.valueOf(yr+i));
	    			year5.setAction(String.valueOf((yr+i)-1900));
	    			break;
	    		case 6 :
	    			year6.setText(String.valueOf(yr+i));
	    			year6.setAction(String.valueOf((yr+i)-1900));
	    			break;
	    		case 7 :
	    			year7.setText(String.valueOf(yr+i));
	    			year7.setAction(String.valueOf((yr+i)-1900));
	    			break;
	    		case 8 :
	    			year8.setText(String.valueOf(yr+i));
	    			year8.setAction(String.valueOf((yr+i)-1900));
	    			break;
	    		case 9 :
	    			year9.setText(String.valueOf(yr+i));
	    			year9.setAction(String.valueOf((yr+i)-1900));
	    	}
	}
