...
public class CollapsePanel extends Composite implements ClickHandler, HasResizeHandlers {
    ...
    protected Widget                        topContainer;
    protected int                           topWidth = -1;
    ...
    public CollapsePanel(boolean open){
		...
		*/
        ...
        setCSS(UIResources.INSTANCE.collapse());
    ...
    public void open() {
        if(!isOpen){
            ...
            if(topContainer != null) {
                if(topWidth < 0)
                    topWidth = topContainer.getOffsetWidth();
                topContainer.setWidth(topWidth + content.getOffsetWidth()+"px");
            }
    ...
    public void close(){
        ...
        if(isOpen){
            ...
            isOpen = false;       
            if(topContainer != null) 
                topContainer.setWidth(topWidth+"px");
            ResizeEvent.fire(this, content.getOffsetWidth(), content.getOffsetHeight());
        }
    }
	...
	public void setTopContainer(Widget container) {
