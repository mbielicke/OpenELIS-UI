 ...
 * 
 */
public class TableHeader extends FocusPanel {
    ...
    protected View<? extends Controller>    view;
     ...
     */
    protected TableHeader     source = this;
    ...
    public void init(final Controller table, View<? extends Controller> view) {
        ...
        addHandler(new MouseDownHandler() {
            public void onMouseDown(MouseDownEvent event) {
                ...
                if (popResize == null) {
                    ...
                    bar = new FocusPanel();
                    bar.setWidth("1px");
                    bar.setHeight((view.scrollView().getOffsetHeight() + getOffsetHeight())+"px");
                    ...
                    bar.addMouseMoveHandler(new MouseMoveHandler() {
                        public void onMouseMove(MouseMoveEvent event) {
                            ...
                            Column column = table.getColumnAt(resizeColumn);
                ...
                popResize.show();
                if(view.scrollView().getMaximumHorizontalScrollPosition() > 0)
                    bar.setHeight(view.scrollView().getOffsetHeight() + getOffsetHeight() - NativeHorizontalScrollbar.getNativeScrollbarHeight()+"px");
                else
                    bar.setHeight((view.scrollView().getOffsetHeight() + getOffsetHeight())+"px");
                /*
    ...
    private void showFilter(int column) {
        ...
        if (table.getColumnAt(column).isFilterable() || table.getColumnAt(column).isSortable || table.getColumnAt(column).getMenuItems() != null) {
            ...
            if (x > table.getWidthWithoutScrollbar() +
                    view.scrollView().getHorizontalScrollPosition())
                return;
            x -= 17;
            /*
